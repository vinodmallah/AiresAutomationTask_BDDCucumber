Feature: Login Page Feature
  ...
  Scenario: Validating Login functionality with valid credential
    Given user is on Aires application login page
    When user enters valid UserName "rohit.sharma@intsof.com"
    And user clicks on Next button
    And user enters valid Password "relonetng1"
  ...
  Scenario: Validating Forgot Password functionality with Invalid Username and user clicks on Back to Login button
    Given user is on Aires application login page
    When user enters valid UserName "vinod.invalid@intsof.com"
    And user clicks on Next button
    And user clicks on Forgot password? link
